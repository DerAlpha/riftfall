...
export const PDW_VIEWMODEL: WeaponViewmodelDef = {
  ...
  reload: {
    ...
    tactical: {
      ...
      keys: [
        { t: 0.12, pos: V(-0.035, 0.028, 0.012), rot: V(8, 12, 16) },
        { t: 0.21, pos: V(-0.04, 0.034, 0.014), rot: V(10, 14, 20) },
        { t: 0.42, pos: V(-0.045, 0.028, 0.012), rot: V(5, 16, 24) },
        { t: 0.64, pos: V(-0.045, 0.034, 0.012), rot: V(8, 15, 22) },
    ...
    empty: {
      ...
      keys: [
        { t: 0.1, pos: V(-0.035, 0.028, 0.012), rot: V(8, 12, 16) },
        { t: 0.163, pos: V(-0.04, 0.034, 0.014), rot: V(10, 14, 20) },
        { t: 0.36, pos: V(-0.045, 0.028, 0.012), rot: V(5, 16, 24) },
        { t: 0.51, pos: V(-0.045, 0.034, 0.012), rot: V(8, 15, 22) },
