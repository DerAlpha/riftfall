...
export const VFX_EFFECTS = {
  ...
  'explosion.ice': {
    ...
    emitters: [
      ...
      // Ice shards catch the light: glinting (additive) splinters that bounce on the floor.
      {
        blend: 'add',
        sprite: 'shard',
        count: [26, 40],
  ...
  'field.fire.flames': {
    emitters: [
      tongues([1, 1], [0.4, 0.7], [0.4, 0.7], [1.4, 2.6], 2.6, {
        minCount: 1,
        stretch: 0.15,
        drag: 2.2,
        sizeEnd: 0.4,
  ...
  'field.poison.mist': {
    emitters: [
      billow('smoke', [0.6, 0.9, 0.32], [1, 1], [1.2, 1.8], 2.2, [2.5, 4], [0.1, 0.4], 0.4, {
        minCount: 1,
        axis: 'up',
        drag: 0.8,
        gravity: -0.02,
  ...
  'field.frost.mist': {
    emitters: [
      ...
      // Cold luminous haze hugging the floor (lit mist alone is grey).
      {
        blend: 'add',
        sprite: 'mist',
        count: [0, 1],
  ...
  'combo.superconductor': {
    emitters: [
      ...
      streaks([0.45, 0.72, 1], [16, 24], [8, 18], [0.08, 0.2], 9, 180, {
        drag: 6,
        stretch: 0.045,
        gravity: 0,
      }),
