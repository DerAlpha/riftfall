...
export interface CamoShaderDef {
  ...
  readonly animation: { readonly kind: CamoAnimationKind; readonly speed: number; readonly intensity: number };
}
...
export const CAMOS: readonly CamoDef[] = [
  // --- weapon level camos ---
  {
    ...
    shader: { pattern: 'urban', colors: [0x3a3d42, 0x6b7078, 0xa9aeb5], scale: 3, roughness: 0.7, metalness: 0.2, animation: STATIC },
  },
  {
    id: 'camo.digital',
    name: 'Digitalmuster',
    ...
    shader: { pattern: 'digital', colors: [0x2b3226, 0x4d5a3c, 0x8a9468], scale: 6, roughness: 0.65, metalness: 0.2, animation: STATIC },
  },
  {
    id: 'camo.tiger',
    name: 'Tigerstreifen',
    ...
    shader: { pattern: 'tiger', colors: [0x1c1a17, 0x9c5a1e, 0xd8a24a], scale: 2.5, roughness: 0.6, metalness: 0.15, animation: STATIC },
  },
  {
    id: 'camo.hex',
    name: 'Wabenpanzer',
    ...
    shader: { pattern: 'hex', colors: [0x14181f, 0x2d3a4a, 0x5fa8d8], scale: 8, roughness: 0.45, metalness: 0.6, animation: STATIC },
  },
  {
    id: 'camo.carbon',
    name: 'Kohlefaser',
    ...
    shader: { pattern: 'carbon', colors: [0x0d0e10, 0x24272c, 0x3c4048], scale: 14, roughness: 0.35, metalness: 0.3, animation: STATIC },
  },
  {
    id: 'camo.circuit',
    name: 'Schaltkreis',
  ...
  // --- weapon challenge camos ---
  {
    ...
    shader: { pattern: 'metal', colors: [0x5a3a1c, 0x9c6b3a, 0xd9a066], scale: 1, roughness: 0.3, metalness: 1, animation: STATIC },
  },
  {
    id: 'camo.gold',
    name: 'Gold',
    ...
    shader: { pattern: 'metal', colors: [0x7a5a12, 0xd4a82c, 0xffe28a], scale: 1, roughness: 0.2, metalness: 1, animation: STATIC },
  },
  {
    id: 'camo.platinum',
    name: 'Platin',
    ...
    shader: { pattern: 'metal', colors: [0x6c7078, 0xc9ced6, 0xf4f7fb], scale: 1, roughness: 0.15, metalness: 1, animation: STATIC },
  },
  {
    id: 'camo.obsidian',
    name: 'Obsidian',
    ...
    shader: { pattern: 'marble', colors: [0x050507, 0x1a1420, 0x6a3cff], scale: 2, roughness: 0.1, metalness: 0.4, animation: STATIC },
  },
  {
    id: 'camo.diamond',
    name: 'Diamant',
...
const CHARMS: readonly CharmDef[] = [
  { kind: 'charm', id: 'charm.tag', name: 'Hundemarke', rarity: 'common', unlock: { kind: 'level', level: 5 }, shape: 'tag', color: 0xb8bcc4 },
  { kind: 'charm', id: 'charm.die', name: 'Glückswürfel', rarity: 'common', unlock: { kind: 'level', level: 15 }, shape: 'die', color: 0xe8e2d4 },
  { kind: 'charm', id: 'charm.skull', name: 'Totenkopf', rarity: 'rare', unlock: { kind: 'achievement', id: 'kills_1000' }, shape: 'skull', color: 0xd9d2c0 },
  { kind: 'charm', id: 'charm.fang', name: 'Schwärmerzahn', rarity: 'rare', unlock: { kind: 'achievement', id: 'swarmers_1000' }, shape: 'fang', color: 0xf0e6c8 },
  { kind: 'charm', id: 'charm.crystal', name: 'Rift-Kristall', rarity: 'epic', unlock: { kind: 'challenge' }, shape: 'crystal', color: 0x7a4dff, glow: 0xb48cff },
  { kind: 'charm', id: 'charm.eye', name: 'Spuckerauge', rarity: 'epic', unlock: { kind: 'challenge' }, shape: 'eye', color: 0x9dff3a, glow: 0x9dff3a },
  { kind: 'charm', id: 'charm.coin', name: 'Letzte Münze', rarity: 'rare', unlock: { kind: 'shop', price: 300 }, shape: 'coin', color: 0xd4a82c },
  { kind: 'charm', id: 'charm.rift', name: 'Riss im Glas', rarity: 'legendary', unlock: { kind: 'prestige', rank: 3 }, shape: 'rift', color: 0x1b0b2e, glow: 0xff3df2 },
];

const CROSSHAIRS: readonly CrosshairDef[] = [
  { kind: 'crosshair', id: 'crosshair.dot', name: 'Punkt', rarity: 'common', unlock: { kind: 'default' }, style: 'dot', color: null },
  { kind: 'crosshair', id: 'crosshair.cross', name: 'Kreuz', rarity: 'common', unlock: { kind: 'default' }, style: 'cross', color: null },
  { kind: 'crosshair', id: 'crosshair.circle', name: 'Kreis', rarity: 'common', unlock: { kind: 'default' }, style: 'circle', color: null },
  { kind: 'crosshair', id: 'crosshair.chevron', name: 'Winkel', rarity: 'common', unlock: { kind: 'default' }, style: 'chevron', color: null },
  { kind: 'crosshair', id: 'crosshair.delta', name: 'Delta', rarity: 'rare', unlock: { kind: 'level', level: 20 }, style: 'delta', color: '#ffb000' },
  { kind: 'crosshair', id: 'crosshair.bracket', name: 'Klammer', rarity: 'rare', unlock: { kind: 'challenge' }, style: 'bracket', color: '#00e5ff' },
  { kind: 'crosshair', id: 'crosshair.rift', name: 'Riss', rarity: 'epic', unlock: { kind: 'achievement', id: 'headshot_streak_25' }, style: 'rift', color: '#ff3df2' },
];

const KILL_EFFECTS: readonly KillEffectDef[] = [
  { kind: 'killEffect', id: 'killfx.default', name: 'Standard', rarity: 'common', unlock: { kind: 'default' }, vfx: 'enemy.death', scale: 1 },
  { kind: 'killEffect', id: 'killfx.ember', name: 'Glut', rarity: 'rare', unlock: { kind: 'achievement', id: 'fire_kills' }, vfx: 'impact.fire', scale: 1.4 },
  { kind: 'killEffect', id: 'killfx.frost', name: 'Frostbruch', rarity: 'rare', unlock: { kind: 'achievement', id: 'ice_kills' }, vfx: 'impact.ice', scale: 1.4 },
  { kind: 'killEffect', id: 'killfx.arc', name: 'Lichtbogen', rarity: 'rare', unlock: { kind: 'achievement', id: 'shock_kills' }, vfx: 'impact.shock', scale: 1.4 },
  { kind: 'killEffect', id: 'killfx.toxic', name: 'Giftwolke', rarity: 'rare', unlock: { kind: 'achievement', id: 'poison_kills' }, vfx: 'impact.poison', scale: 1.4 },
  { kind: 'killEffect', id: 'killfx.void', name: 'Leerenriss', rarity: 'epic', unlock: { kind: 'achievement', id: 'void_kills' }, vfx: 'impact.void', scale: 1.4 },
  { kind: 'killEffect', id: 'killfx.plasma', name: 'Plasmaschmelze', rarity: 'epic', unlock: { kind: 'challenge' }, vfx: 'impact.plasma', scale: 1.3 },
  { kind: 'killEffect', id: 'killfx.nova', name: 'Nova', rarity: 'epic', unlock: { kind: 'shop', price: 500 }, vfx: 'perk.nova.arc', scale: 0.8 },
  { kind: 'killEffect', id: 'killfx.rift', name: 'Riftsog', rarity: 'legendary', unlock: { kind: 'prestige', rank: 1 }, vfx: 'rift.spawn', scale: 0.6 },
  { kind: 'killEffect', id: 'killfx.phoenix', name: 'Phönixfeuer', rarity: 'legendary', unlock: { kind: 'prestige', rank: 7 }, vfx: 'perk.phoenix.flare', scale: 0.7 },
];

const PRESTIGE_FRAMES: readonly EmblemDef['frame'][] = ['bronze', 'bronze', 'bronze', 'silver', 'silver', 'silver', 'gold', 'gold', 'gold', 'rift'];
...
const EMBLEMS: readonly EmblemDef[] = [
  { kind: 'emblem', id: 'emblem.recruit', name: 'Rekrut', rarity: 'common', unlock: { kind: 'default' }, glyph: 'rune', color: 0x9aa3ad, frame: 'plain' },
  { kind: 'emblem', id: 'emblem.level25', name: 'Bewährt', rarity: 'common', unlock: { kind: 'level', level: 25 }, glyph: 'medal', color: 0xc07a3a, frame: 'bronze' },
  { kind: 'emblem', id: 'emblem.level50', name: 'Veteran', rarity: 'rare', unlock: { kind: 'level', level: 50 }, glyph: 'medal', color: 0xc9d3df, frame: 'silver' },
  { kind: 'emblem', id: 'emblem.level100', name: 'Legende', rarity: 'epic', unlock: { kind: 'level', level: 100 }, glyph: 'crown', color: 0xe0b84a, frame: 'gold' },
  { kind: 'emblem', id: 'emblem.trophy', name: 'Trophäenjäger', rarity: 'epic', unlock: { kind: 'achievement', id: 'achievements_30' }, glyph: 'trophy', color: 0xe0b84a, frame: 'gold' },
  ...PRESTIGE_COLORS.map(
    (color, i): EmblemDef => ({
      kind: 'emblem',
