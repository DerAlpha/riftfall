...
export const FIELD_VISUALS = {
  ...
  'field.pull.void': {
    ...
    // Refreshed every frame since the per-interval re-flash (a strobe) went: × ~0.8 for the same mean.
    light: { color: [0.55, 0.25, 1], intensity: 24, range: 9, interval: 0.09 },
    fadeIn: 0.25,
    fadeOut: 0.35,
  },
  ...
  'field.damage.fire': {
    ...
    infall: null,
    lens: null,
    light: { color: [1, 0.45, 0.14], intensity: 32, range: 7, interval: 0.07, offset: 0.6, flicker: 0.3 },
    fadeIn: 0.2,
    fadeOut: 0.8,
  },
  ...
  'field.damage.poison': {
    ...
    infall: null,
    lens: null,
    light: { color: [0.35, 1, 0.25], intensity: 11, range: 6, interval: 0.12, offset: 0.5, flicker: 0.12 },
    fadeIn: 0.4,
    fadeOut: 1,
  },
  ...
  'field.slow.ice': {
    ...
    infall: null,
    lens: null,
    light: { color: [0.45, 0.75, 1], intensity: 14, range: 7, interval: 0.12, offset: 0.4, flicker: 0.08 },
    fadeIn: 0.35,
    fadeOut: 0.9,
  },
