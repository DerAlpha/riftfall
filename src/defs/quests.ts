...
export const LAB_QUEST: QuestDef = {
  ...
  steps: [
    ...
    { kind: 'collect', id: 'core', items: [{ id: 'rift_core', position: [0, 1.55, -1] }], carry: 'rift_core' },
    {
      kind: 'interact',
      id: 'feed',
      requires: 'rift_core',
    ...
    { kind: 'defend', id: 'containment', point: [-7.2, 0, -25.8], radius: 7, duration: 60, grace: 3, decay: 0.5 },
  ],
