...
export const VFX_EFFECTS = {
  ...
  // --- perk blasts (M4, defs/perks.ts PERK_TUNING.*.fx, spawned at the player's feet): floor-level
  // bursts without smoke, scorch or full shake – they go off under the first-person camera ---
  'perk.nova': {
    emitters: [
      {
        blend: 'add',
  ...
  'perk.kinetic': {
    ...
    light: { color: [1, 0.7, 0.45], intensity: 60, range: 7, duration: 0.2, offset: 0.4, priority: 1 },
  ...
  'perk.phoenix': {
    emitters: [
      ...
      // The fire front: flames thrown out along the floor that burn out before they reach the eye.
      {
        blend: 'add',
        sprite: 'flame',
        count: [18, 24],
