 ...
 * animation. reset() closes it again for a new run (collider, bullets and nav blocked again).
 *
...
import { DOORS, INTERACTION } from '../defs/interactables';
...
export class Door {
  ...
  fixedUpdate(dt: number): void {
    ...
    if (!this.passable && this.t >= DOORS.passableAt) {
      this.passable = true;
