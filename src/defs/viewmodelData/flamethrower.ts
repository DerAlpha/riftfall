 ...
 * Reload: the fuel tank is unhooked from the left flank and a full one hooked on (magOut/magIn);
 * on an empty reload the pilot re-ignites with a puff (boltRelease).
...
export const FLAMETHROWER_VIEWMODEL: WeaponViewmodelDef | null = {
  ...
  reload: {
    style: 'timeline',
    // Rolled right: the left-flank tank (and its gauge) turn towards the camera.
    tactical: {
      markers: { magOut: 0.25, magIn: 0.66 },
      keys: [
        { t: 0.12, pos: V(-0.035, 0.035, 0.03), rot: V(10, 16, -30) },
        { t: 0.25, pos: V(-0.04, 0.04, 0.034), rot: V(13, 18, -35) },
        { t: 0.47, pos: V(-0.045, 0.026, 0.03), rot: V(6, 20, -37) },
        { t: 0.66, pos: V(-0.045, 0.034, 0.03), rot: V(9, 18, -33) },
        { t: 0.85, pos: V(-0.014, 0.008, 0.01), rot: V(3, 6, -10) },
      ],
    },
    empty: {
      ...
      keys: [
        ...
        { t: 0.52, pos: V(-0.045, 0.034, 0.03), rot: V(9, 18, -33) },
        // Nozzle up and in: the pilot re-ignites in front of the eye.
        { t: 0.68, pos: V(-0.04, 0.045, 0.02), rot: V(14, 20, -8) },
        { t: 0.8, pos: V(-0.04, 0.048, 0.022), rot: V(16, 20, -10) },
  ...
  glow: { accent: 2.3, readout: 2.5, sight: 5, heat: 5.5 },
  drivers: [
