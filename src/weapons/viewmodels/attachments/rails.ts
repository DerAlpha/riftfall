...
export const buildVertGrip: AttachmentBuilder = (b) => {
  b.add(BODY, 'darkMetal', roundedBox(0.022, 0.009, 0.034, 0.0015), { pos: [0, -0.0045, 0], paint: P.darkMetal.paint });
  ...
  b.add(BODY, 'darkMetal', new CylinderGeometry(0.0128, 0.0124, 0.007, 18), { pos: [0, -0.082, 0], paint: P.darkMetal.paint });
...
export const buildAngleGrip: AttachmentBuilder = (b) => {
  b.add(BODY, 'darkMetal', roundedBox(0.022, 0.006, 0.064, 0.0015), { pos: [0, -0.003, 0], paint: P.darkMetal.paint });
  b.add(
    BODY,
    'polymer',
    profileX(
...
export const buildStabilizer: AttachmentBuilder = (b) => {
  const GY = -0.037;
  b.part('gyro', [0, GY, 0]);
  b.add(BODY, 'darkMetal', roundedBox(0.022, 0.008, 0.032, 0.0015), { pos: [0, -0.004, 0], paint: P.darkMetal.paint });
  b.add(BODY, 'darkMetal', new BoxGeometry(0.01, 0.014, 0.014), { pos: [0, -0.014, 0], paint: P.darkMetal.paint });
  b.add(BODY, 'darkMetal', tubeZ(0.0205, 0.0172, 0.046, 28), { pos: [0, GY, 0.023], paint: P.darkMetal.paint });
...
export const buildLightStock: AttachmentBuilder = (b) => {
  b.add(BODY, 'darkMetal', roundedBox(0.02, 0.024, 0.02, 0.002), { pos: [0, -0.006, 0.01], paint: P.darkMetal.paint });
  ...
  for (const z of [0.055, 0.115]) b.add(BODY, 'darkMetal', new BoxGeometry(0.005, 0.036, 0.005), { pos: [0, -0.013, z] });
  b.add(BODY, 'polymer', roundedBox(0.022, 0.086, 0.013, 0.003), { pos: [0, -0.016, 0.163], paint: P.polymer.paint });
...
export const buildHeavyStock: AttachmentBuilder = (b) => {
  b.add(BODY, 'darkMetal', cylinderZ(0.0145, 0.0145, 0.13, 20), { pos: [0, 0, 0.065], paint: P.darkMetal.paint });
  b.add(BODY, 'polymer', roundedBox(0.03, 0.02, 0.085, 0.004), { pos: [0, 0.021, 0.09], paint: P.polymer.paint });
  b.add(BODY, 'polymer', roundedBox(0.03, 0.058, 0.07, 0.005), { pos: [0, -0.029, 0.112], paint: P.polymer.paint });
  b.add(BODY, 'darkMetal', roundedBox(0.032, 0.02, 0.032, 0.003), { pos: [0, -0.062, 0.1], paint: P.darkMetal.paint });
...
export const buildTacticalLaser: AttachmentBuilder = (b) => {
  b.add(BODY, 'darkMetal', roundedBox(0.018, 0.006, 0.024, 0.0012), { pos: [0, 0.003, 0], paint: P.darkMetal.paint });
  b.add(BODY, 'polymer', roundedBox(0.022, 0.017, 0.038, 0.002), { pos: [0, 0.0145, -0.002], paint: P.polymer.paint });
...
export const buildTargetLaser: AttachmentBuilder = (b) => {
  const Y = 0.0155;
  b.add(BODY, 'darkMetal', roundedBox(0.018, 0.006, 0.03, 0.0012), { pos: [0, 0.003, 0], paint: P.darkMetal.paint });
  b.add(BODY, 'darkMetal', cylinderZ(0.0095, 0.0095, 0.062, 18), { pos: [0, Y, -0.006], paint: P.darkMetal.paint });
