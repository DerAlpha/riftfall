...
export const ELEMENTS = {
  ...
  rim: {
    ...
    // The rim is HDR (× the renderer's rim intensity): saturated colors, or tone mapping bleaches them.
    frozen: { color: 0x7cc6ff, strength: 0.85, pulse: 0.08, rate: 2 },
    shocked: { color: 0x2f7dff, strength: 0.75, pulse: 0.7, rate: 31 },
    burn: { color: 0xff4208, strength: 0.75, pulse: 0.3, rate: 13 },
    voidMark: { color: 0x7a2cff, strength: 0.8, pulse: 0.35, rate: 4.5 },
    poisoned: { color: 0x3cff14, strength: 0.4, pulse: 0.15, rate: 3, perStack: 0.08 },
    chill: { color: 0x4a9cff, strength: 0.25, pulse: 0.05, rate: 2, perStack: 0.12 },
  },
