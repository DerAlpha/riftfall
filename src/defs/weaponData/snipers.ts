...
export const SNIPERS = {
  sniper: {
    ...
    vfx: { muzzle: 'muzzle.sniper', impact: 'impact.bullet', casing: 'casing.rifle', muzzleLightColor: 0xffb870 },
  ...
  marksman: {
    ...
    vfx: { muzzle: 'muzzle.sniper', impact: 'impact.bullet', casing: 'casing.rifle', muzzleLightColor: 0xffb468 },
